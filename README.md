...
rules are true. **This was created as a code challenge and also to explore ideas
for some tools I was thinking of**.
...
# Install
`composer require johnpancoast/data-processor:~0`
